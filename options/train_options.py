...
class TrainOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--dataset_type', default='wifi_encode', type=str, help='Type of dataset/experiment to run')
		self.parser.add_argument('--encoder_type', default='CSN', type=str, help='Which encoder to use')
